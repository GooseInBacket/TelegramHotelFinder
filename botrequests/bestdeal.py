...
def best_deal(users: User,
    ...
    3 этап. Приём от пользователя даты выезда из отеля, начиная с даты заезда.
    4 этап. Приём от пользователя минимальной комфортной цены
    5 этап. Приём от пользователя максимальной комфортной цены
    6 этап. Приём от пользователя максимальной дистанции от центра
    7 этап. Приём кол-ва результатов и запрос необходимости фото.
    8 этап. Приём необходимости фото и их кол-ва
    9 этап. Подведение итогов запроса
