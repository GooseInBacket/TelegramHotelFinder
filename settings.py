...
CLEAR_HISTORY = 'ℹ История ваших команд пуста.\nЧтобы это исправить введите /help'
...
ERR_NO_CITY = '🚫 Невозможно найти город "{}".\n🔁 Попробуйте заново: {}'
ERR_API = '🚫 В данный момент бот не может выполнить команду. Сообщите о проблеме владельцу.'
ERR_BAD_KEY = 'API-KEY исчерпал кол-во запросов. Status code: {}'
